package com.Fee.system.user.realm;
...
import com.Fee.common.exception.CaptchaException;
...
import com.Fee.system.user.domain.UsernamePasswordCaptchaToken;
import com.Fee.system.user.service.UserService;
import com.Fee.system.user.service.UserServiceImpl;
...
public class UserRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
		...
		User user = userService.getUser(token.getUsername(), true);

		// 用于比较大小写
		if (!token.getUsername().equals(user.getAccount()))
			user = null;
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		User user = userService.getUser(shiroUser.loginName, false);
		...
		// 业务角色
		List<Integer> roleIds = userService.getUserRoleIds(user.getId());

		// 赋予权限
		List<Integer> menuIds = roleService.getRoleMenuIds(roleIds);
