...
<body>
	...
	<div id="mainLayout" class="easyui-layout hidden" data-options="fit: true">
		<div id="northPanel" data-options="region: 'north', border: false" style="height: 80px; overflow: hidden;">
			<div id="topbar" class="top-bar">
				<div class="top-bar-left">
					<h1 style="margin-left: 10px; margin-top: 10px;color: #fff">
						<span style="color: #3F4752">后台管理系统</span>
					</h1>
				</div>
			...
			<div id="toolbar" class="panel-header panel-header-noborder top-toolbar">
				<div id="infobar">
					<span class="icon-hamburg-user" style="padding-left: 25px; background-position: left center;"> <shiro:principal
							property="name" />，您好
					</span>
				</div>

				<div id="buttonbar">
					<span>更换皮肤：</span> <select id="themeSelector"></select> <a href="javascript:void(0);" class="easyui-menubutton"
					...
					<div id="layout_north_set">
						...
						<div id="btnUpdPwd">修改密码</div>
						<div id="btnExit" data-options="iconCls:'logout'" onclick="logout()">退出系统</div>
					</div>
			...
			<div id="mainTabs" class="easyui-tabs"
				...
				<div id="homePanel" data-options="title: '主页', iconCls: 'icon-hamburg-home'">
					<div class="easyui-layout" data-options="fit: true">
						<div data-options="region: 'north', split: false, border: false" style="height:800px;">
							<div>
								首页
							</div>
						</div>
	...
	<script>
		...
		$.ajax({ async : false, type : 'get', url : "${ctx}/system/menu/i/json", success : function(data) {
		...
		function updatePwd() {
			d = $("#dlg").dialog(
					{ title : '修改密码', width : 380, height : 280, href : '${ctx}/system/user/updatePwd',
		...
		*/
		...
		var ws = new WebSocket('ws://47.52.129.158/ws');
	            
	    ws.onopen = function () {  
	          console.info('ws 链接成功');  
	      };  
	        
	      ws.onmessage = function (event) {  
	          $.messager.alert(event.data);
	      };  
