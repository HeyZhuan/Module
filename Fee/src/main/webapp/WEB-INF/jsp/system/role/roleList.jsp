    ...
    <div data-options="region:'east',split:true,border:false,title:'权限列表'" style="width: 425px">
    	...
    	<div id="tg_tb" style="padding:5px;height:auto">
		   ...
		   <%--  <shiro:hasRole name="admin"> --%>
		    	...
		    	<span class="toolbar-item dialog-tool-separator"></span>
		        <a href="#" class="easyui-linkbutton"  iconCls="icon-sum"plain="true" onclick="javascript:permissionDg.treegrid('selectAll');">选择所有</a>
		  <%--   </shiro:hasRole> --%>
		    </div>
		</div>
...
$(function(){   
    ...
    columns:[[    
        ...
        {field:'des',title:'描述',sortable:true,width:100,tooltip: true},
        {field:'status',title:'状态',formatter:formatState,sortable:true,width:100,tooltip: true},
	...
	permissionDg=$('#permissionDg').treegrid({   
	    ...
	    columns:[[    
	        ...
	        {field:'des',title:'描述',width:100,tooltip: true}
	    ]],
...
function save(){
	...
	if (data){
		...
		$.ajax({
			...
			url:"${ctx}/system/role/"+roleId+"/updateMenu",
			success: function(data){
				debugger;
				successTip(data);
			}
